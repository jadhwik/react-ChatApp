 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xo{constructor(e,n){this.shortDelay=e,this.longDelay=n,Vn(n>e,"Short delay should be less than long delay!"),this.isMobile=x1()||L1()}get(){return iA()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function dA(t,e){return Fn(t,"POST","/v1/accounts:delete",e)}async function F0(t,e){return Fn(t,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function SA(t,e={}){return Fn(t,"GET","/v2/passwordPolicy",Sr(t,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function VA(t,e){const n=Nu(t,"auth");if(n.isInitialized()){const i=n.getImmediate(),s=n.getOptions();if(Do(s,e??{}))return i;Mt(i,"already-initialized")}return n.initialize({options:e})}function bA(t,e){const n=(e==null?void 0:e.persistence)||[],r=(Array.isArray(n)?n:[n]).map(An);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function MA(t,e,n){const r=Rr(t);K(r._canInitEmulator,r,"emulator-config-failed"),K(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const i=!1,s=Y0(e),{host:o,port:l}=UA(e),u=l===null?"":`:${l}`;r.config.emulator={url:`${s}//${o}${u}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:o,port:l,protocol:s.replace(":",""),options:Object.freeze({disableWarnings:i})}),FA()}function Y0(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function UA(t){const e=Y0(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const r=n[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(r);if(i){const s=i[1];return{host:s,port:e_(r.substr(s.length+1))}}else{const[s,o]=r.split(":");return{host:s,port:e_(o)}}}function e_(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function FA(){function t(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",t):t())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vf{constructor(e,n){this.providerId=e,this.signInMethod=n}toJSON(){return Sn("not implemented")}_getIdTokenResponse(e){return Sn("not implemented")}_linkToIdToken(e,n){return Sn("not implemented")}_getReauthenticationResolver(e){return Sn("not implemented")}}async function jA(t,e){return Fn(t,"POST","/v1/accounts:signUp",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xn extends Jo{constructor(){super("github.com")}static credential(e){return Zr._fromParams({providerId:Xn.PROVIDER_ID,signInMethod:Xn.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Xn.credentialFromTaggedObject(e)}static credentialFromError(e){return Xn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Xn.credential(e.oauthAccessToken)}catch{return null}}}Xn.GITHUB_SIGN_IN_METHOD="github.com";Xn.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Z0(t,e,n=!1){if(Ht(t.app))return Promise.reject(Pn(t));const r="signIn",i=await J0(t,r,e),s=await ei._fromIdTokenResponse(t,r,i);return n||await t._updateCurrentUser(s.user),s}async function XA(t,e){return Z0(Rr(t),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ew(t){const e=Rr(t);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function YA(t,e,n){if(Ht(t.app))return Promise.reject(Pn(t));const r=Rr(t),o=await cd(r,{returnSecureToken:!0,email:e,password:n,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",KA).catch(u=>{throw u.code==="auth/password-does-not-meet-requirements"&&ew(t),u}),l=await ei._fromIdTokenResponse(r,"signIn",o);return await r._updateCurrentUser(l.user),l}function JA(t,e,n){return Ht(t.app)?Promise.reject(Pn(t)):XA(Ee(t),us.credential(e,n)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&ew(t),r})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function uw(t,e){return e?An(e):(K(t._popupRedirectResolver,t,"argument-error"),t._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const AC="pendingRedirect",ml=new Map;class CC extends cw{constructor(e,n,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,r),this.eventId=null}async execute(){let e=ml.get(this.auth._key());if(!e){try{const r=await PC(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(n){e=()=>Promise.reject(n)}ml.set(this.auth._key(),e)}return this.bypassAuthState||ml.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function PC(t,e){const n=xC(e),r=NC(t);if(!await r._isAvailable())return!1;const i=await r._get(n)==="true";return await r._remove(n),i}function kC(t,e){ml.set(t._key(),e)}function NC(t){return An(t._redirectPersistence)}function xC(t){return pl(AC,t.config.apiKey,t.name)}async function DC(t,e,n=!1){if(Ht(t.app))return Promise.reject(Pn(t));const r=Rr(t),i=uw(r,e),o=await new CC(r,i,n).execute();return o&&!n&&(delete o.user._redirectEventId,await r._persistUserIfCurrent(o.user),await r._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const th="webStorageSupport";class lP{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=iw,this._completeRedirectFn=DC,this._overrideRedirectResult=kC}async _openPopup(e,n,r,i){var s;Vn((s=this.eventManagers[e._key()])===null||s===void 0?void 0:s.manager,"_initialize() not called before _openPopup()");const o=await a_(e,n,r,ld(),i);return nP(e,o,Uf())}async _openRedirect(e,n,r,i){await this._originValidation(e);const s=await a_(e,n,r,ld(),i);return hC(s),new Promise(()=>{})}_initialize(e){const n=e._key();if(this.eventManagers[n]){const{manager:i,promise:s}=this.eventManagers[n];return i?Promise.resolve(i):(Vn(s,"If manager is not set, promise should be"),s)}const r=this.initAndGetManager(e);return this.eventManagers[n]={promise:r},r.catch(()=>{delete this.eventManagers[n]}),r}async initAndGetManager(e){const n=await XC(e),r=new LC(e);return n.register("authEvent",i=>(K(i==null?void 0:i.authEvent,e,"invalid-auth-event"),{status:r.onEvent(i.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=n,r}_isIframeWebStorageSupported(e,n){this.iframes[e._key()].send(th,{type:th},i=>{var s;const o=(s=i==null?void 0:i[0])===null||s===void 0?void 0:s[th];o!==void 0&&n(!!o),Mt(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const n=e._key();return this.originValidationPromises[n]||(this.originValidationPromises[n]=FC(e)),this.originValidationPromises[n]}get _shouldInitProactively(){return G0()||Lf()||xu()}}const uP=lP;var l_="@firebase/auth",u_="1.7.3";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function G(t="Unexpected state"){const e=`FIRESTORE (${cs}) INTERNAL ASSERTION FAILED: `+t;throw bn(e),new Error(e)}function ce(t,e){t||G()}function Y(t,e){return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;this.y_?(bn(n),this.y_=!1):H("OnlineStateTracker",n)}C_(){this.p_!==null&&(this.p_.cancel(),this.p_=null)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rp{constructor(e,n,r,i,s){this.asyncQueue=e,this.timerId=n,this.targetTimeMs=r,this.op=i,this.removalCallback=s,this.deferred=new kn,this.then=this.deferred.promise.then.bind(this.deferred.promise),this.deferred.promise.catch(o=>{})}get promise(){return this.deferred.promise}static createAndSchedule(e,n,r,i,s){const o=Date.now()+r,l=new rp(e,n,o,i,s);return l.start(r),l}start(e){this.timerHandle=setTimeout(()=>this.handleDelayElapsed(),e)}skipDelay(){return this.handleDelayElapsed()}cancel(e){this.timerHandle!==null&&(this.clearTimeout(),this.deferred.reject(new q(U.CANCELLED,"Operation cancelled"+(e?": "+e:""))))}handleDelayElapsed(){this.asyncQueue.enqueueAndForget(()=>this.timerHandle!==null?(this.clearTimeout(),this.op().then(e=>this.deferred.resolve(e))):Promise.resolve())}clearTimeout(){this.timerHandle!==null&&(this.removalCallback(this),clearTimeout(this.timerHandle),this.timerHandle=null)}}function ip(t,e){if(bn("AsyncQueue",`${e}: ${t}`),ta(t))return new q(U.UNAVAILABLE,`${e}: ${t}`);throw t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cp{constructor(e){this.observer=e,this.muted=!1}next(e){this.observer.next&&this.Ka(this.observer.next,e)}error(e){this.observer.error?this.Ka(this.observer.error,e):bn("Uncaught Error in snapshot listener:",e.toString())}$a(){this.muted=!0}Ka(e,n){this.muted||setTimeout(()=>{this.muted||e(n)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 *
 * @license MIT
 */function kd(){return kd=Object.assign?Object.assign.bind():function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(t[r]=n[r])}return t},kd.apply(this,arguments)}function IO(t,e){if(t==null)return{};var n={},r=Object.keys(t),i,s;for(s=0;s<r.length;s++)i=r[s],!(e.indexOf(i)>=0)&&(n[i]=t[i]);return n}function SO(t){return!!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)}function RO(t,e){return t.button===0&&(!e||e==="_self")&&!SO(t)}const AO=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","unstable_viewTransition"],CO="6";try{window.__reactRouterVersion=CO}catch{}const PO="startTransition",ry=hI[PO];function kO(t){let{basename:e,children:n,future:r,window:i}=t,s=M.useRef();s.current==null&&(s.current=LD({window:i,v5Compat:!0}));let o=s.current,[l,u]=M.useState({action:o.action,location:o.location}),{v7_startTransition:c}=r||{},f=M.useCallback(p=>{c&&ry?ry(()=>u(p)):u(p)},[u,c]);return M.useLayoutEffect(()=>o.listen(f),[o,f]),M.createElement(EO,{basename:e,children:n,location:l.location,navigationType:l.action,navigator:o,future:r})}const NO=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",xO=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,DO=M.forwardRef(function(e,n){let{onClick:r,relative:i,reloadDocument:s,replace:o,state:l,target:u,to:c,preventScrollReset:f,unstable_viewTransition:p}=e,m=IO(e,AO),{basename:w}=M.useContext(Cr),A,P=!1;if(typeof c=="string"&&xO.test(c)&&(A=c,NO))try{let v=new URL(window.location.href),N=c.startsWith("//")?new URL(v.protocol+c):new URL(c),L=Sp(N.pathname,w);N.origin===v.origin&&L!=null?c=L+N.search+N.hash:P=!0}catch{}let k=oO(c,{relative:i}),I=OO(c,{replace:o,state:l,target:u,preventScrollReset:f,relative:i,unstable_viewTransition:p});function y(v){r&&r(v),v.defaultPrevented||I(v)}return M.createElement("a",kd({},m,{href:A||k,onClick:P||s?r:y,ref:n,target:u}))});var iy;(function(t){t.UseScrollRestoration="useScrollRestoration",t.UseSubmit="useSubmit",t.UseSubmitFetcher="useSubmitFetcher",t.UseFetcher="useFetcher",t.useViewTransitionState="useViewTransitionState"})(iy||(iy={}));var sy;(function(t){t.UseFetcher="useFetcher",t.UseFetchers="useFetchers",t.UseScrollRestoration="useScrollRestoration"})(sy||(sy={}));function OO(t,e){let{target:n,replace:r,state:i,preventScrollReset:s,relative:o,unstable_viewTransition:l}=e===void 0?{}:e,u=Zu(),c=ha(),f=fT(t,{relative:o});return M.useCallback(p=>{if(RO(p,n)){p.preventDefault();let m=r!==void 0?r:hu(c)===hu(f);u(t,{replace:m,state:i,preventScrollReset:s,relative:o,unstable_viewTransition:l})}},[c,u,f,r,i,n,t,s,o,l])}const LO="/assets/google-Vxclqtie.png",VO=()=>{M.useState("");const[t,e]=M.useState(""),[n,r]=M.useState(""),[i,s]=M.useState(""),o=Zu(),l=async()=>{try{await JA(wn,t,n),wn.currentUser&&o("/"),console.log(currentUser)}catch(c){console.error(c),s("Incorrect email or password")}},u=async()=>{var c;try{await RC(wn,OD),console.log((c=wn==null?void 0:wn.currentUser)==null?void 0:c.email)}catch(f){console.error(f)}};return V.jsx("div",{className:"  min-h-screen flex flex-col gap-3  justify-center  ",children:V.jsxs("div",{className:" bg-slate-400 p-5 flex flex-col justify-center items-center rounded-lg  ",children:[V.jsx("h1",{className:"text-3xl text-white",children:"Login"}),V.jsxs("div",{className:"flex flex-col gap-3 p-5 items-center ",children:[V.jsx("input",{className:"p-1 bg-slate-300 border-none outline-none",type:"email",placeholder:"email",value:t,onChange:c=>e(c.target.value)}),V.jsx("input",{className:"p-1 bg-slate-300 border-none outline-none",type:"password",placeholder:"password",value:n,onChange:c=>r(c.target.value)}),V.jsx("button",{className:"p-2  bg-slate-500 ",onClick:l,children:"Login"}),i&&V.jsx("p",{className:"text-red-500",children:i}),V.jsxs("p",{className:" text-black text-opacity-50 hover:text-opacity-100",children:["Already have account?",V.jsx(DO,{to:"/register",children:"Register"})]}),V.jsx("button",{onClick:u,children:V.jsx("img",{src:LO,className:"w-8"})})]})]})})},hi=M.createContext(),bO=({children:t})=>{const[e,n]=M.useState({});return M.useEffect(()=>{const r=rC(wn,i=>{n(i)});return()=>{r()}},[]),V.jsx(hi.Provider,{value:{currentUser:e},children:t})},gT="/assets/profile-t9qNVa76.jpg",da=M.createContext(),MO=({children:t})=>{const{currentUser:e}=M.useContext(hi),n={chatId:"null",user:{}},r=(o,l)=>{switch(l.type){case"CHANGE_USER":return{user:l.payload,chatId:e.uid>l.payload.uid?e.uid+l.payload.uid:l.payload.uid+e.uid};default:return o}},[i,s]=M.useReducer(r,n);return V.jsx(da.Provider,{value:{data:i,dispatch:s},children:t})},UO=({userData:t,currentTime:e,setUser:n,user:r,handleChats:i,chats:s})=>{const[o,l]=M.useState(null),{currentUser:u}=M.useContext(hi),[c,f]=M.useState(""),p=i,{dispatch:m}=M.useContext(da);console.log(u);const w=()=>{l(gT)};console.log(t);const A=v=>{const N=v.target.value;f(N),n(N),p()},P=t.filter(v=>v.uid!==u.uid).filter(v=>v.username.toLowerCase().includes(c.toLowerCase()));console.log(P);const k=c?P:t.filter(v=>v.uid!==u.uid),I=async(v,N)=>{await setDoc(doc(db,"userChats",v),{lastActiveChat:N},{merge:!0})},y=v=>{m({type:"CHANGE_USER",payload:v}),I(u.uid,data.chatId)};return V.jsxs("div",{className:"flex flex-col",children:[V.jsxs("div",{className:" bg-stone-400 bg-opacity-50 flex flex-col max-w-lg  ",children:[V.jsxs("div",{className:"flex flex-row items-center  justify-between ",children:[V.jsx("h1",{className:"text-2xl font-bold text-white  ml-6",children:"Chats"}),V.jsx("button",{onClick:()=>iC(wn),className:"text-white p-2 bg-slate-400 m-3 rounded-lg h-10 bg-opacity-50 hover:bg-opacity-100",children:"Logout"})]}),V.jsx("input",{type:"text",placeholder:"Search",onChange:A,value:c,className:"m-5 w-auto rounded-md text-center bg-white bg-opacity-50 border-none outline-none ml-15"})]}),V.jsx("div",{className:" chat  sm:w-auto sm:text-sm md:w-auto md:text-md h-auto ",children:V.jsx("div",{className:"flex flex-col justify-start bg-stone-300 bg-opacity-50 w-72 p-2 rounded-md m-2 h-96 overflow-y-scroll",children:s&&Object.entries(s).map(([v,N])=>{var b,E;const L=N.userInfo;return k.some(_=>_.uid===L.uid)?V.jsx("button",{onClick:()=>y(L),children:V.jsxs("div",{className:"flex flex-row justify-between items-center p-2 hover:bg-zinc-500 hover:bg-opacity-50 rounded-md",children:[V.jsxs("div",{className:"flex flex-row justify-center items-center",children:[V.jsx("img",{src:o||L.photoURL,onError:w,className:"w-10 rounded-full",alt:""}),V.jsxs("div",{className:"flex flex-col justify-center item-center p-2",children:[V.jsx("p",{className:"text-white font-bold",children:L.displayName}),V.jsx("p",{className:"text-white m-1",children:(b=N.lastMessage)==null?void 0:b.inputText})]})]}),V.jsx("p",{className:"text-red-700 text-sm",children:(E=N.lastMessage)==null?void 0:E.times})]})},L.uid):null})})})]})},Nd="/assets/pdf-DRnJaAAA.png",FO=({userData:t,currentTime:e,chats:n})=>{const r=e();console.log(r);const{currentUser:i}=M.useContext(hi),{data:s,dispatch:o}=M.useContext(da),[l,u]=M.useState([]);M.useState(!1),M.useState(null);const[c,f]=M.useState(null),p=w=>{f(w)},m=()=>{f(null)};return M.useEffect(()=>{const w=async()=>{const P=await Tl(Jt($t,"userChats",i.uid));if(P.exists()){const k=P.data().lastActiveChat;k&&o({type:"CHANGE_USER",payload:{chatId:k}})}},A=()=>{const P=LE(Jt($t,"chats",s.chatId),k=>{k.exists()&&u(k.data().messages)});return()=>{P()}};i.uid&&w(),i.uid&&A()},[i.uid,s.chatId,o]),console.log("messages are",l),V.jsxs("div",{className:"w-full",children:[V.jsx("div",{className:"bg-slate-300 mt-3 bg-opacity-50 h-96 p-2 overflow-y-scroll   sm:text-sm md:text-md lg:text-md",children:V.jsx("div",{className:"flex flex-col gap-3",children:l.map(w=>V.jsx("div",{className:`flex ${w.senderId===i.uid?"justify-end":"justify-start"} items-center gap-5`,children:w.senderId===i.uid?V.jsxs(V.Fragment,{children:[V.jsxs("div",{className:"flex flex-col items-end",children:[w.inputText!==""&&V.jsx("p",{className:`p-1 w-fit h-auto ${w.senderId===i.uid&&w.inputText!==""?"bg-blue-500 text-white rounded-l-xl rounded-br-xl pl-4 pr-2":"bg-white text-black rounded-r-xl rounded-bl-xl pl-4 pr-2"}`,children:w.inputText||""}),w.img&&V.jsx("img",{src:w.img,alt:"Uploaded",className:"w-20 rounded-md mt-2",onClick:()=>p(w.img)}),w.file&&V.jsxs("div",{className:"bg-slate-300 bg-opacity-50 p-3 rounded-lg",children:[w.fileName.endsWith(".pdf")?V.jsx("img",{src:Nd,alt:"PDF Icon",className:"w-8 mr-2"}):null,V.jsx("a",{href:w.file,target:"_blank",rel:"noopener noreferrer",className:"text-white mt-2 underline",children:w.fileName||"File"})]}),V.jsx("p",{className:"text-xs text-gray-500",children:w.time})]}),V.jsx("img",{src:i.photoURL,className:"w-10 rounded-full",alt:"User avatar"})]}):V.jsxs(V.Fragment,{children:[V.jsx("img",{src:s.user.photoURL,className:"w-10 rounded-full",alt:"User avatar"}),V.jsxs("div",{className:"flex flex-col items-start",children:[w.inputText&&V.jsx("div",{className:"",children:V.jsx("p",{className:`p-1 w-auto h-auto ${w.senderId===i.uid?"bg-blue-500 text-white rounded-l-xl rounded-br-xl pl-4 pr-2":"bg-white text-black rounded-r-xl rounded-bl-xl pl-4 pr-2"}`,children:w.inputText})}),w.img&&V.jsx("img",{src:w.img,alt:"Uploaded",className:"w-32 rounded-md mt-2",onClick:()=>p(w.img)}),w.file&&V.jsxs("div",{className:"bg-slate-300 bg-opacity-50 p-3 rounded-lg",children:[w.fileName.endsWith(".pdf")?V.jsx("img",{src:Nd,alt:"PDF Icon",className:"w-8 mr-2"}):null,V.jsx("a",{href:w.file,target:"_blank",rel:"noopener noreferrer",className:"text-white mt-2 underline",children:w.fileName||"File"})]}),V.jsx("p",{className:"text-xs text-gray-500",children:w.time})]})]})},w.id))})}),c&&V.jsxs("div",{className:"fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex justify-center items-center",children:[V.jsx("img",{src:c,alt:"Enlarged",className:"max-w-full max-h-full"}),V.jsx("button",{onClick:m,className:"absolute top-2 right-2 text-white bg-red-500 px-2 py-1 rounded-md",children:"Close"})]})]})},jO="/assets/send-DkJ6XdFK.png",BO="/assets/image--JfwN_-Fz.png",zO="/assets/attachment-HcYtqp6r.png";let el;const $O=new Uint8Array(16);function HO(){if(!el&&(el=typeof crypto<"u"&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto),!el))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return el($O)}const je=[];for(let t=0;t<256;++t)je.push((t+256).toString(16).slice(1));function qO(t,e=0){return je[t[e+0]]+je[t[e+1]]+je[t[e+2]]+je[t[e+3]]+"-"+je[t[e+4]]+je[t[e+5]]+"-"+je[t[e+6]]+je[t[e+7]]+"-"+je[t[e+8]]+je[t[e+9]]+"-"+je[t[e+10]]+je[t[e+11]]+je[t[e+12]]+je[t[e+13]]+je[t[e+14]]+je[t[e+15]]}const WO=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),oy={randomUUID:WO};function ay(t,e,n){if(oy.randomUUID&&!e&&!t)return oy.randomUUID();t=t||{};const r=t.random||(t.rng||HO)();return r[6]=r[6]&15|64,r[8]=r[8]&63|128,qO(r)}const KO=({currentTime:t})=>{const e=t();console.log(e);const{data:n}=M.useContext(da),[r,i]=M.useState(""),[s,o]=M.useState(null),[l,u]=M.useState(null),{currentUser:c}=M.useContext(hi),[f,p]=M.useState("Text"),m=()=>{p(f==="Text"?"Text":f==="Files"?"Files":"Images")},w=async()=>{const N=L=>new Promise((b,E)=>{const _=sT(oT,ay()),T=rT(_,L);T.on("state_changed",null,S=>E(S),()=>{iT(T.snapshot.ref).then(S=>b(S)).catch(S=>E(S))})});try{let L=null,b=null;l&&(L=await N(l)),s&&(b=await N(s));const E={id:ay(),inputText:r,senderId:c.uid,date:De.now(),time:e,img:L,file:b,fileName:s?s.name:null};await fo(Jt($t,"chats",n.chatId),{messages:vx(E)}),await fo(Jt($t,"userChats",c.uid),{[n.chatId+".lastMessage"]:{inputText:r,times:e},[n.chatId+".data"]:uu()}),await fo(Jt($t,"userChats",n.user.uid),{[n.chatId+".lastMessage"]:{inputText:r,times:e},[n.chatId+".data"]:uu()}),i(""),u(null),o(null)}catch(L){console.error("Error uploading file: ",L)}},[A,P]=M.useState(null),[k,I]=M.useState(null),y=N=>{const L=N.target.files[0];if(u(L),L){const b=new FileReader;b.onloadend=()=>{P(b.result)},b.readAsDataURL(L)}else P(null)},v=N=>{const L=N.target.files[0];if(o(L),L){const b=new FileReader;b.onloadend=()=>{I(b.result)},b.readAsDataURL(L)}else I(null)};return V.jsx("div",{className:"bg-slate-200 mb-18 bg-opacity-50  p-2  flex flex-row justify-center items-center gap-2",children:V.jsxs(V.Fragment,{children:[V.jsx("input",{type:"text",value:r,onChange:N=>{i(N.target.value),m()},placeholder:"Type something here",className:"bg-slate-200 bg-opacity-50 w-1/2 border-none outline-none placeholder-black p-1 rounded-md"}),V.jsx("button",{children:V.jsx("img",{src:jO,className:"w-8",onClick:w})}),V.jsx("input",{type:"file",accept:"images/*",id:"file",className:"  hidden",onChange:y}),V.jsx("label",{htmlFor:"file",children:A?V.jsx("img",{src:A,className:"w-8",alt:"Image Preview"}):V.jsx("img",{src:BO,className:"w-8",alt:"Image Icon"})}),V.jsx("input",{type:"file",id:"files",accept:".docx,.pdf",className:"hidden",onChange:v}),V.jsx("label",{htmlFor:"files",children:V.jsx("img",{src:s&&s.type==="application/pdf"?Nd:zO,className:"w-8",alt:"Upload File"})})]})})},GO="/assets/video-hBr3jibc.png",QO="/assets/call-Ds60eEI5.png",XO=()=>{var I,y;const{currentUser:t}=M.useContext(hi),{data:e}=M.useContext(da),[n,r]=M.useState([]),i=rx($t,"Users"),[s,o]=M.useState(null);M.useState("");const[l,u]=M.useState("");console.log("data from auth is",e);const c=l&&n?n.filter(v=>v.uid!==t.uid).filter(v=>v.username.toLowerCase().includes(l.toLowerCase())):[],f=c.length>0?c[0].uid:null;console.log("filtered data",c),M.useEffect(()=>{(async()=>{try{const L=(await yx(i)).docs.map(b=>({...b.data(),id:b.id}));r(L),console.log(L)}catch(N){console.log(N)}})()},[]);const p=()=>{const v=new Date,N=v.getHours(),L=v.getMinutes();let b="AM";N>12&&(b="PM");let E=N%12;E===0&&(E=12);const _=`${E}.${L}${b}`;return console.log(_),_},m=p();console.log("times is printing",m);const w=()=>{o(gT)},[A,P]=M.useState([]);M.useEffect(()=>{const v=()=>{const N=LE(Jt($t,"userChats",t.uid),L=>{P(L.data())});return()=>{N()}};t.uid&&v()},[t.uid]),console.log(t.uid);const k=async()=>{var N,L;if(!f){console.error("User ID is missing or invalid.");return}const v=t.uid>f?t.uid+f:f+t.uid;try{const b=Jt($t,"chats",v);(await Tl(b)).exists()||await Il(b,{messages:[]});const _={uid:t.uid,displayName:t.displayName,photoURL:t.photoURL},T={uid:f,displayName:((N=c[0])==null?void 0:N.username)||"Unknown User",photoURL:((L=c[0])==null?void 0:L.photoURL)||null};console.log("current userinfo",_),console.log("other userinfo",T);const S=Jt($t,"userChats",t.uid);(await Tl(S)).exists()||await Il(S,{});const x=Jt($t,"userChats",f);(await Tl(x)).exists()||await Il(x,{}),await fo(S,{[`${v}.userInfo`]:T,[`${v}.date`]:uu()}),await fo(x,{[`${v}.userInfo`]:_,[`${v}.date`]:uu()})}catch(b){console.log("Error updating chats:",b)}};return V.jsx("div",{className:"flex flex-col w-full  gap-0",children:V.jsxs("div",{className:" flex flex-row",children:[V.jsx(UO,{userData:n,currentTime:p,user:l,setUser:u,handleChats:k,chats:A}),V.jsxs("div",{className:"flex flex-col w-full",children:[V.jsxs("div",{className:"flex flex-row items-center  justify-between  bg-zinc-500 bg-opacity-50 p-2 ",children:[V.jsxs("div",{className:"flex flex-row items-center",children:[V.jsx("img",{src:s||((I=e.user)==null?void 0:I.photoURL),onError:w,className:"w-16 rounded-full ",alt:""}),V.jsx("p",{className:"text-white",children:(y=e.user)==null?void 0:y.displayName})]}),V.jsxs("div",{className:"flex flex-row justify-end gap-3",children:[V.jsx("img",{src:GO,className:"w-8"}),V.jsx("img",{src:QO,className:"w-8"})]})]}),V.jsxs("div",{children:[V.jsx(FO,{userData:n,currentTime:p,chats:A}),V.jsx(KO,{currentTime:p})]})]})]})})},YO="/assets/addpro-RnIDWnqF.png",JO=()=>{const[t,e]=M.useState(""),[n,r]=M.useState(""),[i,s]=M.useState(""),[o,l]=M.useState(null),[u,c]=M.useState(""),[f,p]=M.useState(""),m=Zu(),w=async()=>{try{if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(n)){console.error("Invalid email address");return}const P=await YA(wn,n,i);if(!o){console.error("Please select a profile picture");return}const k=sT(oT,`uploads/${P.user.uid}/${o.name}`),I=rT(k,o);I.on(y=>{setErr(!0)},()=>{iT(I.snapshot.ref).then(async y=>{await eC(P.user,{displayName:t,phoneNumber:f,photoURL:y}),console.log("upload successful",y),await Il(Jt($t,"Users",P.user.uid),{uid:P.user.uid,username:t,email:n,phone:f,password:i,photoURL:y,bio:u})})}),m("/login"),console.log("success")}catch(A){console.log(A)}};return V.jsx("div",{className:"flex flex-col justify-center",children:V.jsxs("div",{className:" bg-slate-400 p-5 flex flex-col justify-center items-center rounded-lg ",children:[V.jsx("h1",{className:"text-3xl text-white",children:"Register"}),V.jsxs("div",{className:"flex flex-col gap-2 p-5",children:[V.jsx("input",{className:"p-1 bg-slate-300 border-none outline-none",type:"text",placeholder:"username",onChange:A=>e(A.target.value)}),V.jsx("input",{className:"p-1 bg-slate-300 border-none outline-none",type:"email",placeholder:"email",onChange:A=>r(A.target.value)}),V.jsx("input",{className:"p-1 bg-slate-300 border-none outline-none",type:"text",placeholder:"Phone number",onChange:A=>p(A.target.value)}),V.jsx("input",{className:"p-1 bg-slate-300 border-none outline-none",type:"password",placeholder:"password",onChange:A=>s(A.target.value)}),V.jsx("label",{htmlFor:"image-upload",children:V.jsx("img",{src:YO,className:"w-16"})}),V.jsx("input",{type:"file",id:"image-upload",accept:"image/*",className:"hidden",onChange:A=>l(A.target.files[0])}),V.jsx("textarea",{className:"p-1 bg-slate-300 border-none outline-none resize-none",rows:"2",placeholder:"add any bio here",onChange:A=>c(A.target.value)}),V.jsx("button",{className:"p-2  bg-slate-500 ",onClick:w,children:"Register"}),V.jsx("p",{className:" text-black text-opacity-50 hover:text-opacity-100",children:"Already have account?Login"})]})]})})},ZO=()=>{const{currentUser:t}=M.useContext(hi),e=({children:n})=>t?n:V.jsx(wO,{to:"/login/"});return V.jsx("div",{className:" app flex flex-row gap-0 p-5  w-full h-screen  justify-center items-center",children:V.jsx(kO,{children:V.jsx(TO,{children:V.jsxs(Ys,{path:"/",children:[V.jsx(Ys,{index:!0,element:V.jsx(e,{children:V.jsx(XO,{})})}),V.jsx(Ys,{path:"login",element:V.jsx(VO,{})}),V.jsx(Ys,{path:"register",element:V.jsx(JO,{})})]})})})})};ch.createRoot(document.getElementById("root")).render(V.jsx(bO,{children:V.jsx(MO,{children:V.jsx(yy.StrictMode,{children:V.jsx(ZO,{})})})}));
